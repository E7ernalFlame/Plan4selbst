...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  // Extrahiere Kanzlei-Name aus displayName (Format: Name||Kanzlei)
  ...
  return (
    <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6 sticky top-0 z-50 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4 text-slate-400 font-bold text-xs uppercase tracking-widest italic opacity-50">Business Intelligence Portal</div>
    </header>
  );
};
